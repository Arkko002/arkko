<template>
	<div>
		...
		<div class="flex flex-col h-screen pt-10 bg-gray-100 border-t-4">
			<span class="self-center">Contact Me</span>

			<div
				class="items-center h-full pb-10 justify-items-center grid grid-cols-2"
			>
